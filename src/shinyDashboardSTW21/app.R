...
ui <- fluidPage(
  ...
  navbarPage(title = HTML("<img src='./DSPG_black-01.png' width='120px' style='margin-top:-10px;'/>"),
             tabPanel("About",style = "margin:45px",
                      ...
                      p("The NSF board projects that by 2022, the US will have 3.4 million unfilled STW jobs, so it is important to learn more about how to gain credentials for these occupations."),
